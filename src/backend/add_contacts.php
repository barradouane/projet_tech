...
try {
    $stmt = $pdo->prepare("INSERT INTO contacts (site, nom, prenom, email, telephone, service, niveau_de_formation)
                           VALUES (:site, :nom, :prenom, :email, :telephone, :service, :niveau_de_formation)");
