...
export default function Navbar() {
  ...
  const servicesMenu = showServices && (
    <ul className="rounded-[10px] absolute left-0 sm:left-auto sm:right-0 top-full bg-secondary text-light mt-0 w-full sm:w-[200px] sm:max-h-[450px] max-h-[300px] overflow-y-auto">
      ...
      <ServiceMenuItem href="https://portail.eilco.fr:28/">
        Moodle
      </ServiceMenuItem>
      <ServiceMenuItem href="//cloudeilco.univ-littoral.fr/">
        NextCloud
      </ServiceMenuItem>
      <ServiceMenuItem href="https://webmail.univ-littoral.fr/">
        Zimbra
      </ServiceMenuItem>
      <ServiceMenuItem href="https://www.absence.eilco-ulco.fr/">
        Demande d'autorisation d'absence
      </ServiceMenuItem>
      <ServiceMenuItem href="/stage-service" isLink={true}>
        Stages et alternances
      </ServiceMenuItem>
      <ServiceMenuItem href="https://www.bulco.univ-littoral.fr/">
        Bibliothèque de l'ULCO
      </ServiceMenuItem>
