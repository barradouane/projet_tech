...
export default function ContactsForEditor() {
  ...
  const fetchContacts = async () => {
    setLoading(true)
    try {
      let url = `http://localhost/projet_tech-WorkingVersion/src/backend/get_contacts.php?site=Calais`
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/delete_contacts.php", {
        method: "POST",
        body: formData,
      })
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/update_contacts.php", {
        method: "POST",
        body: formDataToSend,
      })
