export default function EventsData(props){
    return(
        <div className="p-2 sm:mx-4 sm:my-8 my-2 mx-4 relative sm:w-[30%] w-[90%] text-start shadow-[0_5px_25px_2px_rgba(0,0,0,0.11)] rounded-lg cursor-pointer">
            ...
            <h6 className="inline-block bg-light text-left px-4 rounded-lg font-medium text-secondary italic">{props.date}    </h6>
