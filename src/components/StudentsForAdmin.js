...
export default function StudentsForAdmin() {
  ...
  const fetchStudents = async () => {
    try {
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/get_users.php")
      if (!response.ok) {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/update_user.php", {
        method: "PUT",
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/delete_student.php", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
