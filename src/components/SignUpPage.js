...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/projet_tech-latest/src/backend/signup.php", {
        method: "POST",
  ...
  return (
    <div className="flex items-center justify-center py-10 sm:px-0 px-4 bg-[url('../assets/images/heroPicture.jpg')] bg-no-repeat bg-cover bg-center">
