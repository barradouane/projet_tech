...
export default function PostsForEditor() {
  ...
  const fetchPosts = async () => {
    try {
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/get_data.php")
      if (!response.ok) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch("http://localhost/projet_tech-WorkingVersion/src/backend/delete_actualite.php", {
        method: "POST",
        headers: {
